            ...
            <div className="flex">
              {[1, 2, 3, 4, 5].map((star) => {
                ...
                if (star <= Math.floor(currentRating)) {
                  ...
                  return (
                    <div key={star} className="relative w-3 h-3 sm:w-4 sm:h-4">
                      <Star className="w-3 h-3 sm:w-4 sm:h-4 fill-gray-200 text-gray-200 absolute" />
                  ...
                  return <Star key={star} className="w-3 h-3 sm:w-4 sm:h-4 fill-gray-200 text-gray-200" />;
                }
              })}
            </div>
